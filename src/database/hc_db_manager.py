...
class HabrCareerDataBaseManager(LoggingConfigClassMixin):
    """Класс для создания запросов к базе данных с компаниями и вакансиями HabrCareer"""

    def __init__(self, db_name: str) -> None:
        super().__init__()
        self._hc_dbname = db_name
        ...
        try:
            with self._conn.cursor() as cur:
                ...
                if cur.description:  # есть ли результаты
                    ...
                    rows = []
            self._conn.commit()
            self.logger.info(f"Запрос к базе данных {self.hc_dbname} выполнен успешно")
    ...
    def get_companies_and_vacancies_count(self) -> Optional[list]:
        ...
        query = """
                ...
                FROM hc_companies AS c
                LEFT JOIN hc_vacancies AS v ON c.hc_employer_id = v.hc_employer_id
    ...
    def get_all_vacancies(self) -> list:
        ...
        query = """
                ...
                FROM hc_companies as c
                JOIN hc_vacancies as v ON c.hc_employer_id = v.hc_employer_id
    ...
    def get_vacancies_with_higher_salary(self) -> list:
        ...
        query = """
                ...
                JOIN hc_companies AS c ON
                c.hc_employer_id = v.hc_employer_id
                JOIN (SELECT AVG(average_salary) AS avg_salary FROM hc_vacancies) AS s
    ...
    def get_vacancies_with_keyword(self, key_word: str) -> list:
        ...
        query = """
                SELECT c.employer_name, v.vac_name, v.salary_from, v.salary_to, v.vac_area, v.vac_url
                FROM hc_vacancies AS v
                JOIN hc_companies AS c ON c.hc_employer_id = v.hc_employer_id
